      ...
      <div className="max-w-[1240px] mx-auto px-4 md:px-0">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 text-center md:text-left">
          ...
          <div>
            <Link to="/" className="flex flex-col items-center mb-4">
              ...
              <span className="text-[#a87c47] text-xl font-bold">
                Air Ceylon
              </span>
            </Link>
          ...
          <div className="md:ml-6">
            ...
            <ul className="space-y-2 text-md text-gray-500">
              {[
                ...
                <li key={text}>
                  <button
                    onClick={() => handleNavigation(path, "top")}
            ...
            <ul className="space-y-2 text-md text-gray-500">
              {[
                ...
                <li key={region}>
                  <button
                    onClick={() =>
                      handleNavigation("/services/visa-service", region)
                    }
                    className="hover:text-[#a87c47] hover:underline"
                  >
                    {region
        ...
        <div className="mt-14 text-md text-center">
          <p className="mb-6 px-4">
            <label className="font-bold">Visit us by Appointment:</label>{" "}
            <span className="text-gray-400">
              Air Ceylon International, 252A, Galle Road, Colombo 4
        ...
        {/* Bottom Footer */}
        <div className="text-center text-md mt-8 text-gray-600">
          <p>
